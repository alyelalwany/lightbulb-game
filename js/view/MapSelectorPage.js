...
// import { showSavedGames } from "../utils/HelperFunctions.js";
...
function handleClick(event) {
  ...
  if (idSelector == "load-games") {
    ...
    if (!containerToReveal.innerHTML) {
      containerToReveal.innerHTML = `        <span
    >If there are no games here, click on
    <b><i>Get saved games</i></b> at the bottom left
    </span>`;
    }
  }
